...
class RekapModel extends Model
{
    ...
    //     return $ret;
    // }
    public function getRekapkegiatan()
    {
    ...
    public function getLaporByTgl($tglAwal, $tglAkhir)
    {
        ...
        $query->select('a.id_user,a.keterangan,a.path,a.status_iuran,a.path,a.status_cd,a.created_dttm,b.name,b.nik,b.gender,b.email');
        $query->join('bcms_users b', 'b.user_id=a.id_user', 'left');
        $query->where('a.status_cd', 'normal');
        $query->where('a.created_dttm >=', $tglAwal);
        $query->where('a.created_dttm <=',$tglAkhir);
