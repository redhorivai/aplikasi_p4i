      ...
      captionText.innerHTML = dots[slideIndex-1].alt;
        ...
        <div class="col-md-3">
          <div class="sidebar sidebar-right mt-sm-30">
            <div class="widget">
              <h5 class="widget-title line-bottom">Edukasi Terbaru</h5>
              <div class="latest-posts">
                <?php
                foreach ($latestNews as $res) {
                    $image = "<img src='" . base_url() . "/assets-admin/panel/images/youtube.png' style='width:50px;'>";
                  ...
                  if ($res->type == 'edukasi') {
                    echo "<article class='post media-post clearfix pb-0 mb-10'>
                            <a class='post-thumb' href='" . base_url('/informasi/detail_edukasi/' . $res->artikel_id . '') . "'>
                            " . $image . "
                            </a>
