...
<div id="grid-gallery" class="grid-gallery bg-white">
  ...
  <section class="grid-wrap pb-5">
    ...
    <div class="elfsight-app-2bda848a-ac39-4663-9da0-b793a116e455"></div>
  </section>
  <!-- END MAIN SECTION -->
...
<!-- <section class="text-center bg-white pt-0"><a href="#" class="btn btn-gradient">Load More</a></section> -->
<?= $this->endSection(); ?>