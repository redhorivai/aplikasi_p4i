                    ...
                    <div class="card">
                            ...
                            <form class="forms" id="forms" action="post" enctype="multipart/form-data">
		                        <div class="row">
		                            <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="portofolio_nm" id="portofolio_nm" class="form-control" value="<?= $key->portofolio_nm ?>" style="text-transform: capitalize;">
	                       	...
	                       	foreach ($images as $img) {
                                echo "<div class='fileinput-new thumbnail' style='width:165px;height:175px;border:2px solid #e2e2e2;border-radius: 5px; position:relative;'>
                                        <img src='".base_url()."/img/portofolio/$img->images_nm'>
                        ...
                        ?>
		                        ...
		                        <div class="row">
		                        	<div class="row w-50">
		                                <div class="col-sm-6">
		                                    <button onclick="btnupdate(<?= $key->portofolio_id ?>)" type="button" class="btn btn-block btn-primary mb-2 btnSimpan">Simpan</button>
		                                </div>
		                                <div class="col-sm-6">
...
function removeimg(id) {
    Swal.fire({
        ...
        if (result.value) {
            $.ajax({
                type: "post",
                url: "<?= site_url('admin/portofolio/hapusimg') ?>",
                data: {id:id},
                success: function(response) {
                    if (response == "Sukses") {
                        Toast.fire({
