...
<div class="br-mainpanel">
    ...
    <div class="br-pageheader pd-y-15 pd-l-20">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
          ...
          <a class="breadcrumb-item" href="<?= base_url('panel/artikel'); ?>">Konten</a>
          <a class="breadcrumb-item" href="<?= base_url('panel/artikel'); ?>">Informasi</a>
    ...
    <div id="viewData" class="br-pagebody">
        <div class="br-section-wrapper">
            <div class="table-wrapper">
                ...
                <!-- END BUTTON ADD -->
                <!-- TABLE -->
                <?= form_open('Backend/Edukasi/multi_del', ['class' => 'formMultiDelete']) ?>
