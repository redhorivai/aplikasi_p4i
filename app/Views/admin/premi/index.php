...
<div class="br-mainpanel">
    ...
    <div id="viewData" class="br-pagebody">
        <div class="br-section-wrapper">
            ...
            <div class="alert alert-warning alert-bordered pd-y-20 mg-b-15" role="alert">
              <div class="d-sm-flex align-items-center justify-content-start">
                <i class="icon ion-ios-information alert-icon tx-52 mg-r-20"></i>
                <div class="mg-t-20 mg-sm-t-0">
                  <h5 class="mg-b-2">Informasi</h5>
                  <p class="mg-b-0 tx-gray">Pastikan perbarui data anggota<a href="javascript:void(0)" style="color:#DC3545;"> <b><u>Profil Anda</u></b></a></p>
                </div>
              </div>
             </div>
                <!-- BUTTON ADD -->
                ...
                <!-- END BUTTON ADD -->
                <!-- TABLE -->
                <?= form_open('Backend/Premi/multi_del', ['class' => 'formMultiDelete']) ?>
                <table id="viewTable" class="table display responsive w-100">
                  <thead>
                    <tr>
                      ...
                      <th class="tx-center">Data Premi/Iuran</th>
