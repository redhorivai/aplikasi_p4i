...
<div class="br-sideleft overflow-y-auto">
  ...
  <ul class="sidebar-menu">
    ...
    <?php if (session()->get('level') != 'User') { ?>
      <li class="<?php if ($active == "berita" || $active == "artikel" || $active == "edukasi"  || $active == "pengumuman" || $active == "ebook" || $active == "faq") {
                    echo "active";
                  } ?>">
        ...
        <ul class="sidebar-submenu">
          <li class="<?php if ($active == "berita") {
            ...
            <a href="<?= base_url('panel/berita') ?>">- Berita</a>
          </li>
          <li class="<?php if ($active == "artikel") {
                        echo "aktif";
                      } ?>">
            <a href="<?= base_url('panel/artikel') ?>">- Artikel</a>
          </li>
          <li class="<?php if ($active == "edukasi") {
                        echo "aktif";
                      } ?>">
            <a href="<?= base_url('panel/edukasi') ?>">- Edukasi</a>
          </li>
          ...
          <li class="<?php if ($active == "ebook") {
                        echo "aktif";
                      } ?>">
            <a href="<?= base_url('panel/ebook') ?>">- E-book</a>
          </li>
          <li class="<?php if ($active == "faq") {
                        echo "aktif";
                      } ?>">
    ...
    <?php if (session()->get('level') == 'Super User') { ?>
      <li class="<?php if ($active == "pengguna" || $active == "kegiatan") {
                    echo "active";
                  } ?>">
        <a href="javascript:void(0)">
        ...
        <ul class="sidebar-submenu">
          <li class="<?php if ($active == "pengguna") {
                        echo "active";
                      } ?>">
          ...
          <li class="<?php if ($active == "kegiatan") {
                        echo "active";
                      } ?>">
    ...
    <li class="<?php if ($active == "premi" || $active == "kegiatanmember" || $active == "kta") {
                  echo "active";
                } ?>">
      <a href="javascript:void(0)">
      ...
      <ul class="sidebar-submenu">
        <li class="<?php if ($active == "premi") {
                      echo "active";
                    } ?>">
          <a href="<?= base_url('panel/premi') ?>">- Premi/Iuran Member</a>
        </li>
        <li class="<?php if ($active == "kegiatanmember") {
                      echo "active";
                    } ?>">
          <a href="<?= base_url('panel/kegiatanmember') ?>">- Kegiatan Member</a>
        </li>
        <li class="<?php if ($active == "kta") {
                      echo "active";
                    } ?>">
          <a href="<?= base_url('panel/kta') ?>">- E-KTA Digital</a>
        </li>
      </ul>
    </li>
    ...
    <?php if (session()->get('level') !== 'User') { ?>
      ...
      <li class="<?php if ($active == "rekappremi" || $active == "rekapkegiatan" || $active == "saran") {
                    echo "active";
                  } ?>">
        <a href="javascript:void(0)">
        ...
        <ul class="sidebar-submenu">
          <li class="<?php if ($active == "rekappremi") {
                        echo "active";
                      } ?>">
          ...
          <li class="<?php if ($active == "rekapkegiatan") {
                        echo "active";
                      } ?>">
          ...
          <li class="<?php if ($active == "saran") {
                    echo "active";
                  } ?>">
        <a href="<?= base_url('panel/saran') ?>">
          <span>- Rekap Pertanyaan</span>
        </a>
      </li>
        </ul>
      </li>
