...
<div class="br-mainpanel">
    ...
    <div class="br-pagetitle">
        ...
        <div>
            <h4 style="margin-bottom:0 !important;">Report Premi Anggota P4i</h4>
                                        ...
                                        <div class="col-lg-2">
                                            <div class="form-group">
                                                ...
                                                <div class="btn-group" style="min-height:40.6px;">
                                                    <a href="<?= base_url('panel/rekap-premi') ?>" class="btn btn-light tx-12 tx-uppercase tx-mont tx-medium">
