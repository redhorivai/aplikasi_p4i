...
<div class="br-mainpanel">
    ...
    <div class="br-pageheader pd-y-15 pd-l-20">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
          ...
          <a class="breadcrumb-item" href="<?= base_url('panel/faq'); ?>">Konten</a>
          <a class="breadcrumb-item" href="<?= base_url('panel/faq'); ?>">Pasien & Pengunjung</a>
                ...
                <table id="viewTable" class="table display responsive w-100">
                  <thead>
                    <tr>
                      ...
                      <th class="tx-center">Frequently Ask & Question (FAQ)</th>
